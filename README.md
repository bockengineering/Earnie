...
- Sankey balance validation script
...
Future versions can parse company segment, cost of revenue, operating expense, earnings, and earnings-release tables into the `segment_revenue` and `segment_line_items` tables. The app remains functional from local generated data when Supabase environment variables are unavailable.
